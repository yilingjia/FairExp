...
class P_DBGD(TD_DBGD):
    ...
    def __init__(self, PM_n_samples, PM_tau, *args, **kargs):
        ...
        self.multileaving = ProbabilisticMultileave(n_samples=PM_n_samples, tau=PM_tau, n_results=self.n_results)

    @staticmethod
    def default_parameters():
        parent_parameters = TD_DBGD.default_parameters()
        parent_parameters.update(
            {'learning_rate': 0.01, 'learning_rate_decay': 1.0, 'PM_n_samples': 10000, 'PM_tau': 3.0, })
    ...
    def _create_train_ranking(self, query_id, query_feat, inverted):
        ...
        inverted_rankings = rnk.rank_single_query(scores, inverted=True, n_results=None)
