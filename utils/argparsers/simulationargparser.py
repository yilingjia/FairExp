...
class SimulationArgumentParser(argparse.ArgumentParser):
    def __init__(self, description=None, set_arguments={}):
        ...
        self._sim_add_argument(
            "--n_runs", dest="n_runs", default=1, type=int, help="Number of runs to be simulated over a Dataset."
        )

        self._sim_add_argument(
            "--n_impr", dest="n_impressions", default=1000, type=int, help="Number of impressions per simulated run."
        )

        self._sim_add_argument(
            "--vali", dest="validation", action="store_true", help="Use of validation set instead of testset."
        )

        self._sim_add_argument(
            "--vali_in_train",
            dest="validation_in_train",
            action="store_true",
        ...
        self._sim_add_argument(
            ...
            type=str,
            required=True,
            help="Paths to folders where the data-folds are stored.",
            nargs="+",
        )
        ...
        self._sim_add_argument(
            "--click_models", dest="click_models", type=str, required=True, help="Click models to be used.", nargs="+"
        )
        ...
        self._sim_add_argument(
            "--n_results", dest="n_results", default=10, type=int, help="Number of results shown after each query."
        )
        ...
        self._sim_add_argument(
            "--train_only", dest="train_only", action="store_true", help="Only calculate train NDCG."
        )
        ...
        self._sim_add_argument(
            "--lambda", dest="lmbd", default=0.5, type=float, help="regularization parameter",
        )
        self._sim_add_argument(
            "--alpha", dest="alpha", default=0.01, type=float, help="parameter for CB calculation",
        )
        self._sim_add_argument(
            "--seed", dest="seed", default=0, type=int, help="random seed for different runs",
        )
        self._sim_add_argument(
            "--rank",
            dest="rank",
        ...
        self._sim_add_argument(
            "--ind", dest="ind", action="store_true", help="whether to use independent pairs in PairRank"
        )
